...
{
    public class BicubicBezierPatchC0SerializationModel : PatchSerializationModel
    {
        [XmlIgnore]
        ...
        public BicubicBezierPatchC0SerializationModel(BicubicBezierPatchC0 patch) : base(patch)
        {
        ...
        public BicubicBezierPatchC0SerializationModel() { }

        public override (IGeometryObject g, GeometryType type) GetSceneObject()
        {
            BicubicBezierPatchC0 c = ObjectsStaticFactory.CreateObject(GeometryType.BicubicBezierPatchC0) as BicubicBezierPatchC0;
            c.Name = Name;
            ...
            return (c, GeometryType.BicubicBezierPatchC0);
        }
    }
}
